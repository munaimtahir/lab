...
**Repository Source:** /mnt/data/lab-main (local path provided by user)
...
9. In case of any new frontend or backend feature which doesn't have a counter section, develop that too, don't just leave mockups, make fully functional app
